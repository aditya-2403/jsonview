  ...
  return (
    <div className='about-container'>
      ...
      <p>Welcome to JsonView - JSON Hosting!
         We are a leading platform that allows 
         you to securely host and share your JSON 
         files with ease. Whether you're a developer, data analyst, 
         ...
         <h1>Our Mission</h1>
         <p>At JsonView, our mission is to simplify the process of hosting and sharing JSON files.
